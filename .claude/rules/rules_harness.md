...
4. `docs/harness/sprint_<name>_contract.md` を作成する
...
**読み込むファイル（必須）:**
- `docs/harness/sprint_<name>_contract.md`
- `docs/harness/sprint_<name>_feedback.md`（ループ中のみ）
...
- NG の場合は `docs/harness/sprint_<name>_feedback.md` を作成してループを継続する
- OK の場合はテスト実行フェーズへ進む
...
Agent ツール（subagent_type: "general-purpose"）
  prompt: "以下のファイルを読み Sprint Contract を作成してください。
           ...
           出力先: docs/harness/sprint_<name>_contract.md"

# Generator 起動（実装）
Agent ツール（subagent_type: "general-purpose"）
  prompt: "docs/harness/sprint_<name>_contract.md を読み、
           機能実装とテスト設計（pytest / Vitest / Playwright）を行ってください。"

# Evaluator 起動（テスト設計レビュー）
Agent ツール（subagent_type: "general-purpose"）
  prompt: "docs/harness/sprint_<name>_contract.md と .claude/rules/rules_test.md を読み、
           Generator が作成したテスト設計をレビューしてください。
           NG の場合は docs/harness/sprint_<name>_feedback.md を作成してください。"
